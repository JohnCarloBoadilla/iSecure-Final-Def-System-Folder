...
evtSource.addEventListener("logout", function(e) {
  ...
  window.location.href = "/iSecure-Final-Def-System-Folder/php/routes/Pages/login-page.php";
});
...
(function() {
  ...
  function logoutUser() {
    ...
    fetch('/iSecure-Final-Def-System-Folder/php/routes/logout.php', { method: 'POST' })
      .then(() => {
        window.location.href = "/iSecure-Final-Def-System-Folder/php/routes/Pages/login-page.php";
      })
      .catch(error => {
